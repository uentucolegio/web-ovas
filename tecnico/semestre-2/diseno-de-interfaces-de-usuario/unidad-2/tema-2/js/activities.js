// Connection Activity for Style Guide Elements
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Correct answers mapping (elemento -> descripción)
    const correctAnswers = {
        'paleta': 'comunicacion',
        'tipografia': 'legibilidad',
        'iconografia': 'jerarquia',
        'espaciado': 'ritmo'
    };
    ...
    function checkConnections() {
        if (connections.length < 4) {
            resultDiv.innerHTML = `
                <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded">
                    ...
                    <p>Aún tienes ${4 - connections.length} conexión(es) sin hacer. Conecta todos los elementos con sus descripciones.</p>
                </div>
            `;
            return;
        }
        ...
        if (percentage === 100) {
            message = '¡Excelente! Has conectado correctamente todos los elementos de la guía de estilo.';
            ...
            message = 'Vas por buen camino. Revisa la descripción de cada elemento de la guía de estilo.';
            colorClass = 'bg-yellow-100 border-yellow-500 text-yellow-800';
        } else {
            message = 'Necesitas repasar los elementos de la guía de estilo. Inténtalo nuevamente.';
    ...
    function checkWordAnswers() {
        ...
        if (percentage === 100) {
            ...
            message = 'Necesitas repasar los conceptos de guías de estilo. Revisa el contenido e inténtalo nuevamente.';
            colorClass = 'bg-red-100 border-red-500 text-red-800';
        }
