...
// Acordeón independiente para la sección de ejemplo
document.querySelectorAll('[data-accordion-group="independiente"]').forEach(group => {
    const buttons = group.querySelectorAll('.accordion-standalone-btn');

    buttons.forEach(btn => {
        btn.addEventListener('click', () => {
            const panel = group.querySelector(btn.getAttribute('data-target'));
            ...
            group.querySelectorAll('.accordion-standalone-panel').forEach(item => {
