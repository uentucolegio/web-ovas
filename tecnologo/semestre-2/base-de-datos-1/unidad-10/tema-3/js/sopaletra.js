  // Banco de palabras (sin tildes/espacios) relacionadas con el Tema 3
  const wordBank = [
    "CARDINALIDAD","UNOAUNO","UNOAMUCHOS","MUCHOSAMUCHOS","PARTICIPACION",
    "MINIMA","MAXIMA","OBLIGATORIA","OPCIONAL","SUPERCLAVE","CANDIDATA",
    "PRIMARIA","ALTERNA","FORANEA","INTEGRIDAD","REFERENCIAL","DOMINIO","UNICIDAD",
    "ENTIDAD","RELACION"
  ];
